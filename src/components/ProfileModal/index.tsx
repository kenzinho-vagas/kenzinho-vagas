...
const ProfileModal = () => {
  const { isProfileModal, setProfileModal, profileUser, editeProfile } =
          ...
          <div className="theModal">
            <div className="modalHeader">
              ...
              <div className="modalHeaderBtn">
                <CgCloseO
                  onClick={() => setProfileModal(!isProfileModal)}
                  className="iconClose"
                />
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit(editeProfile)}>
                <div className="formColumns">
                  <div className="formLeft">
                    ...
                    <input
                      type="text"
                      placeholder={profileUser?.linkedin}
                      disabled
                    />
                  </div>
                  <div className="formRight">
                    ...
                    <select id="specialty" {...register("specialty")}>
                      <option value="">
                        Especialidade atual: {profileUser?.specialty}
                      </option>
